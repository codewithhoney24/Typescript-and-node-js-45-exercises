...
let _personName : string = "Eric";
let message : string = `Hello ${_personName},would you like to learn some python today?`;
console.log(message);
...
// Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
            ...
            let personName : string = "Muhammad Atif";
...
let _message : string = famous_person + ' once said,"expect the best, prepare for the worst."'
...
//     }
           ...
           //   METHOD 2
           let names1 : string[] = ["saba","ali","hamza","hassan"];    
...
let name1 : string[] = ["Aliza","Zaheer","Aamir","Zameer"];
const messages : string = " \t:  Welcome to typescript classs! and let's start a first topic.";
...
let transportation : string[] = ["Car","Cycle","Train","Motorcycle"];
...
// Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
                     ...
                     let guest_list : string[] = ['Waqar','Ali','Tahir','Mateen','Asif'];
...
let Guest_List2 : string[] = ['Ishaq khan','Noman ali','Aqib'];

// for(let i = 0 ; i <  Guest_List.length ; i++){
//    console.log('Dear Mr.' + Guest_List[i] + ', \n\nIt is our pleasure to invite you in our party for dinner.\n\nTank You!\n\n')
// }

let absent_Guest1 : string = 'Ishaq khan';
let new_Guest1 : string = 'Mansoor shah';
...
let Guest_List : string[] = ['Ishaq khan','Noman ali','Aqib'];

// for(let i = 0 ; i <  Guest_List.length ; i++){
//    console.log('Dear Mr.' + Guest_List[i] + ', \n\nIt is our pleasure to invite you in our party for dinner.\n\nTank You!\n\n')
// }

let absent_Guest : string = 'Ishaq khan';
let new_Guest : string = 'Mansoor shah';
...
let places : string[] = ['Brazil','Denmark','America','England','Colombia'];
...
console.log('original : '+ places.sort().reverse());
        ...
        // METHOD 2
// • Store the locations in a array. Make sure the array is not in alphabetical order.
let places1 : string[] = ['Brazil','Denmark','America','England','Colombia'];
...
let invitations : string[] = ['Mateen','Asif'];
let count : number = invitations.length;
...
let languages : string[] = ['Japanese','Sindhi', 'Punjabi','Hindi','Gujarati','Marathi'];
console.log("\nItem No 1\nList Of Languages : ");
...
let items : {countries : string, cities  : number,languages : string,is_religious : boolean ,is_passport: null} = {countries : "pakistan", cities : 30,languages : "urdu",is_religious : true,is_passport : null};
console.log(items);
...
let communicate : string[] = ['Japanese','Sindhi', 'Punjabi','Hindi','Gujarati','Marathi'];
...
let name_1 : string =  "Nousheen";
let name_2 : string =  "Nousheen Khan";
let name_3 : string =  "nousheen atif";
...
let cities : string[] = ["karachi","islamabad","lahore","multan"];
...
let favorite_fruits : string[] = ["melon","mango","banana","pineapple","blue berry","peach"];
...
let users : string [] = ["eric","ali","zaid","hassan","admin"];
...
let users1 : string [] = ["eric","ali","zaid","hassan","admin"];
...
let current_users : string [] = ["Eric","admin","Fahad","zohra","Amir"];
let new_users : string [] = ["admin","Hina","zohra","Saba","Zia"];
...
let favorite_pizza : string [] = ["mayo garlic","chicken","vegetable","pepperoni"];
...
let animals : string [] = ["horse","cat","lion","dog"];
...
function make_shiirt(size:string = 'large', text:string = 'i love typescript!.') : void {
    console.log(`you order a ${size} ,shirt that says ${text}`);
}
...
const magician : string[] = ["bilawal","ali", "jamshed",'moshin'];
...
const MAGICIANS: string[] = ["zia ","ali ","saad",];
...
const magicians : string[] = ["zia","ali","jamshed"];
...
const mycar : car = createcar("toyota","suzuki",{ color : "black" , year : "2024"});
console.log(mycar);
